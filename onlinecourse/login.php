...
<body <?php include('includes/header.php');?>
	<div class="container boxindex">
       ...
       <p>Welcome to Course Registration System</p>
    </div>
        <div style=" padding-top: 140px;padding-bottom: 120px;">
        
        <ul class="text-center mb-5">

        <li class="list-inline-item ml-3 admin">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
              ...
              <a target="" href="admin/index.php" class="btn btn-indigo btn-lg btn-rounded mr-0" > LOG IN AS ADMIN</a>
        </li>
        ...
        <li class="list-inline-item ml-3 my-auto student">
            ...
            <a target="" href="index.php" class="btn btn-pink btn-lg btn-rounded ml-0">LOG IN AS STUDENT</a>
        </li>
